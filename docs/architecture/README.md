...
- [SQLite store](05-sqlite-store.md): the persisted, on-disk `Corpus`—unified postings, streaming order-agnostic build,
  atomic publish, and a query-bounded resident set.
