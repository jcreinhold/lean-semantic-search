...
The release workflow extracts the section matching a `vX.Y.Z` tag into the GitHub Release body, so every
tagged version must have a corresponding `## [X.Y.Z]` section here.
